...
function makeTableTop() {
  const geometry = new THREE.BoxGeometry(1, 0.05, 0.8);
...
function makeTableModel() {
  ...
  leg1.position.set(-0.45, leg1.position.y, -0.35);
  leg2.position.set(0.45, leg2.position.y, -0.35);
  leg3.position.set(-0.45, leg3.position.y, 0.35);
  leg4.position.set(0.45, leg4.position.y, 0.35);
